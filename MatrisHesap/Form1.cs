    ...
    public partial class Form1 : Form
    {
        ...
        public void matrixSetter(short matName)
        {
            if (matName == 0)
            {
                ...
                do
                {
                    if (A11.Visible == true && A11.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A12.Visible == true && A12.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A13.Visible == true && A13.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A14.Visible == true && A14.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A21.Visible == true && A21.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A22.Visible == true && A22.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A23.Visible == true && A23.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A24.Visible == true && A24.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A32.Visible == true && A32.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A31.Visible == true && A31.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A33.Visible == true && A33.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A34.Visible == true && A34.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A41.Visible == true && A41.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A42.Visible == true && A42.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A43.Visible == true && A43.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (A44.Visible == true && A44.Text.Trim() == string.Empty) { isThereEmptyA = true;}
                    if (isThereEmptyA == true)
                    {
                        MessageBox.Show("Lütfen tüm A matrisini doldurun veya boyutunu düzenleyin.");
                        return;
                    }
            ...
            if (matName == 1)
            {
                ...
                do
                {
                    if (A11.Visible == true && B11.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A12.Visible == true && B12.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A13.Visible == true && B13.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A14.Visible == true && B14.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A21.Visible == true && B21.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A22.Visible == true && B22.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A23.Visible == true && B23.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A24.Visible == true && B24.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A32.Visible == true && B32.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A31.Visible == true && B31.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A33.Visible == true && B33.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A34.Visible == true && B34.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A41.Visible == true && B41.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A42.Visible == true && B42.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A43.Visible == true && B43.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (A44.Visible == true && B44.Text.Trim() == string.Empty) { isThereEmpty = true;}
                    if (isThereEmpty == true)
                    {
                        MessageBox.Show("Lütfen tüm B matrisini doldurun veya boyutunu düzenleyin.");
                        return;
                    }
